...
| <a name="provider_oci"></a> [oci](#provider\_oci) | 8.14.0 |
| <a name="provider_tailscale"></a> [tailscale](#provider\_tailscale) | 0.29.0 |
...
| <a name="input_services"></a> [services](#input\_services) | Service configuration map | <pre>map(object({<br/>    port      = number<br/>    subdomain = string<br/>    waf_block = optional(bool, false)<br/>  }))</pre> | <pre>{<br/>  "audiobookshelf": {<br/>    "port": 8000,<br/>    "subdomain": "abs"<br/>  },<br/>  "freshrss": {<br/>    "port": 80,<br/>    "subdomain": "rss"<br/>  },<br/>  "fulltextrss": {<br/>    "port": 80,<br/>    "subdomain": "ftr"<br/>  },<br/>  "languagetool": {<br/>    "port": 8010,<br/>    "subdomain": "lt",<br/>    "waf_block": true<br/>  },<br/>  "nitter": {<br/>    "port": 8080,<br/>    "subdomain": "nitter",<br/>    "waf_block": true<br/>  },<br/>  "planka": {<br/>    "port": 1337,<br/>    "subdomain": "planka"<br/>  },<br/>  "podly": {<br/>    "port": 5001,<br/>    "subdomain": "podly"<br/>  },<br/>  "redlib": {<br/>    "port": 8080,<br/>    "subdomain": "redlib",<br/>    "waf_block": true<br/>  }<br/>}</pre> | no |
