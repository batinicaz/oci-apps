...
| [oci_core_shape_management.fcos](https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/core_shape_management) | resource |
...
| [oci_identity_policy.block_volume_service](https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/identity_policy) | resource |
...
| <a name="input_services"></a> [services](#input\_services) | Service configuration map | <pre>map(object({<br/>    port             = number<br/>    subdomain        = string<br/>    waf_block        = optional(bool, false)<br/>    rate_limit_paths = optional(set(string), [])<br/>  }))</pre> | <pre>{<br/>  "audiobookshelf": {<br/>    "port": 8000,<br/>    "rate_limit_paths": [<br/>      "login"<br/>    ],<br/>    "subdomain": "abs"<br/>  },<br/>  "freshrss": {<br/>    "port": 80,<br/>    "subdomain": "rss"<br/>  },<br/>  "fulltextrss": {<br/>    "port": 80,<br/>    "subdomain": "ftr"<br/>  },<br/>  "kaneo": {<br/>    "port": 5173,<br/>    "rate_limit_paths": [<br/>      "sign-in"<br/>    ],<br/>    "subdomain": "kaneo"<br/>  },<br/>  "nitter": {<br/>    "port": 8080,<br/>    "subdomain": "nitter",<br/>    "waf_block": true<br/>  },<br/>  "planka": {<br/>    "port": 1337,<br/>    "subdomain": "planka"<br/>  },<br/>  "podly": {<br/>    "port": 5001,<br/>    "rate_limit_paths": [<br/>      "login"<br/>    ],<br/>    "subdomain": "podly"<br/>  },<br/>  "redlib": {<br/>    "port": 8080,<br/>    "subdomain": "redlib",<br/>    "waf_block": true<br/>  },<br/>  "trek": {<br/>    "port": 3000,<br/>    "subdomain": "trek"<br/>  }<br/>}</pre> | no |
